...
PokemonFanClubDOOMSTONEScript:
	opentext
	writetext PokemonFanClubDOOMSTONEText
	cry DOOMSTONE
	waitbutton
	closetext
	end
...
PokemonFanClubDOOMSTONEText:
	text "DOOMSTONE: Li liif!"
	done
...
PokemonFanClub_MapEvents:
	...
	object_event  7,  3, SPRITE_ODDISH, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, PokemonFanClubDOOMSTONEScript, -1
