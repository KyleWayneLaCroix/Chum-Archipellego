...
;	object_event x, y, sprite, movement, rx, ry, h1, h2, palette, type, range, script, event_flag
	...
	object_event 25, 39, SPRITE_ROCKET_GIRL, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 2, TrainerBrianGruntF1, EVENT_BEAT_BRIAN_F_1
	...
	object_event 20,  1, SPRITE_CLAIR, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 3, 3, -1, -1, PAL_NPC_PURPLE, OBJECTTYPE_TRAINER, 1, TrainerHexManiacHanna, -1
