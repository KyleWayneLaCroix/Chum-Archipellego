...
GearCity_MapEvents:
	...
	; warp_event 17,  5, GEAR_CITY_GATE, 1
	...
	object_event 15, 21, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_SCRIPT,0, GearCityCoolTrainerFScript, -1
	...
	object_event  9, 35, SPRITE_GENTLEMAN, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 2, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 0, GearCityGentlemanScript, -1
