...
MrPokemonsHouse_OakScript:
	...
	iftrue .RivalTakesSpirrip
	checkevent EVENT_GOT_SPIRRIP_FROM_ELM
	iftrue .RivalTakesLitwick
	setevent EVENT_HONEDGE_POKEBALL_IN_ELMS_LAB
	end

.RivalTakesSpirrip:
	setevent EVENT_SPIRRIP_POKEBALL_IN_ELMS_LAB
	end

.RivalTakesLitwick:
	setevent EVENT_LITWICK_POKEBALL_IN_ELMS_LAB
	end
