...
;	object_event x, y, sprite, movement, rx, ry, h1, h2, palette, type, range, script, event_flag
	...
	object_event 56, 32, SPRITE_REGIMAGMA, SPRITEMOVEDATA_BIGDOLLSYM, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, RegimagmaOverworld, EVENT_FOUGHT_REGIMAGMA
	object_event 18, 33, SPRITE_GRANNY, SPRITEMOVEDATA_WALK_UP_DOWN, 0, 3, -1, -1, PAL_NPC_PURPLE, OBJECTTYPE_TRAINER, 1, TrainerMediumWell, 0
	object_event  6, 24, SPRITE_GRAMPS, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 2, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 2, TrainerRuinManiacElvin, 0
