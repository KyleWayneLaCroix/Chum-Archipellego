...
NorthernForest_MapEvents:
	...
	object_event 14, 13, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_SCRIPT, 0, HeadbuttGirlScript, -1
	object_event 15, 55, SPRITE_MUSHROOM, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_SCRIPT, 0, NorthernForestMorelull1, EVENT_NORTHERNFOREST_MORELULL1
	object_event 38, 29, SPRITE_MUSHROOM, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_SCRIPT, 0, NorthernForestMorelull2, EVENT_NORTHERNFOREST_MORELULL2
	object_event 18, 42, SPRITE_MUSHROOM, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_ITEMBALL, 0, NorthernForestTinyMushroom1, EVENT_NORTHERNFOREST_TINY_MUSHROOM_1
	object_event 30, 40, SPRITE_MUSHROOM, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_ITEMBALL, 0, NorthernForestTinyMushroom2, EVENT_NORTHERNFOREST_TINY_MUSHROOM_2
