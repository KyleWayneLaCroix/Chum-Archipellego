...
;	object_event x, y, sprite, movement, rx, ry, h1, h2, palette, type, range, script, event_flag
	...
	object_event 41,  9, SPRITE_BLADE_TRAP, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, AwakeningDungeonBladeTrap1, 0, EVEN_BEAT_AWAKENING_DUNGEON_BLADE_TRAP_1
	object_event 31,  2, SPRITE_BLADE_TRAP, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, AwakeningDungeonBladeTrap2, 0, EVEN_BEAT_AWAKENING_DUNGEON_BLADE_TRAP_2
	object_event 23,  2, SPRITE_BLADE_TRAP, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, AwakeningDungeonBladeTrap3, 0, EVEN_BEAT_AWAKENING_DUNGEON_BLADE_TRAP_3
	object_event 17,  5, SPRITE_BLADE_TRAP, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, AwakeningDungeonBladeTrap4, 0, EVEN_BEAT_AWAKENING_DUNGEON_BLADE_TRAP_4
