...
;	object_event x, y, sprite, movement, rx, ry, h1, h2, palette, type, range, script, event_flag
	object_event 13, 27, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1,-1, 0, OBJECTTYPE_TRAINER, 1, TrainerFisherGoro, 0
	object_event 13, 12, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1,-1, 0, OBJECTTYPE_TRAINER, 1, TrainerFisherHenry, 0
	object_event  1, 13, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1,-1, 0, OBJECTTYPE_TRAINER, 1, TrainerFisherMarvin, 0
	object_event 11, 43, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1,-1, 0, OBJECTTYPE_TRAINER, 1, TrainerFisherTully, 0
	object_event  9, 34, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1,-1, 0, OBJECTTYPE_TRAINER, 1, TrainerFisherAndre, 0
	object_event 16,  7, SPRITE_FISHER, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 3, 3, -1,-1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 1, TrainerHikerLeonard, 0
