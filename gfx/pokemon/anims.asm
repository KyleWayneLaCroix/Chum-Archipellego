...
ChompAnimation:   INCLUDE "gfx/pokemon/chomp/anim.asm"
RegimagmaAnimation: INCLUDE "gfx/pokemon/regimagma/anim.asm"
...
MewthreeAnimation: INCLUDE "gfx/pokemon/mewthree/anim.asm"
