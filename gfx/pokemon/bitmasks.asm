...
ChompBitmasks:    INCLUDE "gfx/pokemon/chomp/bitmask.asm"
RegimagmaBitmasks: INCLUDE "gfx/pokemon/regimagma/bitmask.asm"
...
MewthreeBitmasks: INCLUDE "gfx/pokemon/mewthree/bitmask.asm"
