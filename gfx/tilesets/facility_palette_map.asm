	...
	tilepal 0, RED, WATER, WATER, WATER, ROOF, RED, WATER, ROOF
	tilepal 0, GRAY, GRAY, ROOF, ROOF, ROOF, ROOF, ROOF, ROOF
	tilepal 0, ROOF, WATER, WATER, WATER, RED, RED, WATER, WATER
	tilepal 0, GRAY, GRAY, GRAY, GRAY, ROOF, ROOF, ROOF, TEXT
	tilepal 1, GRAY, WATER, WATER, WATER, RED, RED, WATER, WATER
	tilepal 1, GRAY, GRAY, GRAY, GRAY, TEXT, TEXT, TEXT, ROOF
	tilepal 1, GRAY, GRAY, GRAY, GRAY, BROWN, BROWN, BROWN, GREEN
	tilepal 1, GREEN, BROWN, BROWN, TEXT, TEXT, TEXT, TEXT, TEXT
	tilepal 1, GRAY, GRAY, GRAY, GRAY, BROWN, BROWN, BROWN, WATER
	tilepal 1, WATER, GRAY, GRAY, TEXT, TEXT, TEXT, TEXT, TEXT
	tilepal 1, TEXT, TEXT, TEXT, TEXT, GRAY, GREEN, BROWN, BROWN
	tilepal 1, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT
	tilepal 1, TEXT, TEXT, TEXT, TEXT, GREEN, GREEN, BROWN, BROWN
	tilepal 1, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT
	tilepal 1, TEXT, TEXT, TEXT, TEXT, GREEN, GREEN, BROWN, BROWN
