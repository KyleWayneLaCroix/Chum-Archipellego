	...
	tilepal 0, GRAY, GRAY, BROWN, BROWN, BROWN, BROWN, BROWN, BROWN
	tilepal 0, YELLOW, YELLOW, ROOF, ROOF, ROOF, WATER, WATER, WATER
	tilepal 0, GREEN, GREEN, BROWN, BROWN, BROWN, BROWN, ROOF, ROOF
	tilepal 0, YELLOW, YELLOW, ROOF, ROOF, ROOF, ROOF, WATER, WATER
	tilepal 0, GREEN, GREEN, BROWN, BROWN
