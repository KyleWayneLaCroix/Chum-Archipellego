...
WeirdoPic:           INCBIN "gfx/trainers/pokemaniac.2bpp.lz"
...
ITGuyPic:            INCBIN "gfx/trainers/blaine.2bpp.lz"
SupervisorPic:       INCBIN "gfx/trainers/lt_surge.2bpp.lz"
...
FurryPic:            INCBIN "gfx/trainers/victoria.2bpp.lz"
...
ExecutivemPic:       INCBIN "gfx/trainers/ceo.2bpp.lz"
