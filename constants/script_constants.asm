...
; FruitTreeItems indexes (see data/items/fruit_trees.asm)
	...
	const FRUITTREE_ROUTE_B         ; 05
	const FRUITTREE_UNIVERCITY      ; 06
	const FRUITTREE_MUSCLE_JUNGLE_1 ; 07
	const FRUITTREE_MUSCLE_JUNGLE_2 ; 08
...
DEF NUM_BUG_CONTESTANTS EQU 8 ; not counting the player
