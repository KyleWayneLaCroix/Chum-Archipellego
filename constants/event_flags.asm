...
; Photographer
	...
	const EVENT_BEAT_PHOTOGRAPHER_JEFFREY
	const EVENT_BEAT_PHOTOGRAPHER_PING
	const EVENT_BEAT_PHOTOGRAPHER_EDMOND
	const EVENT_BEAT_PHOTOGRAPHER_NEAL
	const EVENT_BEAT_PHOTOGRAPHER_LI
; Camper
...
; Worker
	...
	const EVENT_BEAT_WORKER_JOHNNY
	const EVENT_BEAT_WORKER_DANNY
	const EVENT_BEAT_WORKER_TOMMY
	const EVENT_BEAT_WORKER_DUDLEY
	const EVENT_BEAT_WORKER_JOE
	const EVENT_BEAT_WORKER_BILLY
	const EVENT_BEAT_WORKER_CHAD
	const EVENT_BEAT_WORKER_NATE
	const EVENT_BEAT_WORKER_RICKY
	const EVENT_BEAT_WORKER_JACK2
	const EVENT_BEAT_WORKER_JACK3
	const EVENT_BEAT_WORKER_ALAN2
	const EVENT_BEAT_WORKER_ALAN3
	const EVENT_BEAT_WORKER_CHAD2
	const EVENT_BEAT_WORKER_CHAD3
; Picnicker
...
; IT Guy
	...
	const EVENT_BEAT_IT_GUY_MITCH
	const EVENT_BEAT_IT_GUY_JED
	const EVENT_BEAT_IT_GUY_MARC
	const EVENT_BEAT_IT_GUY_RICH
; Blackbelt
...
; White Girl
	...
	const EVENT_BEAT_WHITE_GIRL_CAROLINE
	const EVENT_BEAT_WHITE_GIRL_CARLENE
	const EVENT_BEAT_WHITE_GIRL_JESSICA
	const EVENT_BEAT_WHITE_GIRL_RACHAEL
	const EVENT_BEAT_WHITE_GIRL_ANGELICA
	const EVENT_BEAT_WHITE_GIRL_KENDRA
	const EVENT_BEAT_WHITE_GIRL_VERONICA
	const EVENT_BEAT_WHITE_GIRL_JULIA
	const EVENT_BEAT_WHITE_GIRL_THERESA
...
; PokefanM
	const EVENT_BEAT_OLD_MAN_WILLIS
...
; Weirdo
	...
	const EVENT_BEAT_WEIRDO_RON
	const EVENT_BEAT_WEIRDO_ETHAN
	const EVENT_BEAT_WEIRDO_BRENT2
	const EVENT_BEAT_WEIRDO_BRENT3
	const EVENT_BEAT_WEIRDO_ISSAC
	const EVENT_BEAT_WEIRDO_DONALD
	const EVENT_BEAT_WEIRDO_ZACH
; GruntM
