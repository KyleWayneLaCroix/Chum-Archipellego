...
; SpawnPoints indexes (see data/maps/spawn_points.asm)
	...
	const SPAWN_CEMETARY
	const SPAWN_UNIVERCITY
	const SPAWN_EEVEE_RANCH
	const SPAWN_MUSCLE_JUNGLE
	const SPAWN_VOLCANO_EXTERIOR
	const SPAWN_MAYBE_VILLAGE
	const SPAWN_IVY_ROAD
	const SPAWN_THE_DARK_LAB
	const SPAWN_INDIGO
...
DEF JOHTO_FLYPOINT EQU const_value
	const FLY_AWAKENING_BEACH
	const FLY_GEAR_CITY
	const FLY_CEMETARY
	const FLY_UNIVERCITY
	const FLY_EEVEE_RANCH
	const FLY_JUNGLE
	const FLY_VOLCANO_EXTERIOR
	const FLY_MAYBE_VILLAGE
	const FLY_IVY_ROAD
	const FLY_THE_DARK_LAB
; kanto
