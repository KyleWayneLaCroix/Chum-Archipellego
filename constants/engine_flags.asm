...
; wVisitedSpawns
	...
	const ENGINE_FLYPOINT_AWAKENING_BEACH
	const ENGINE_FLYPOINT_GEAR_CITY
	const ENGINE_FLYPOINT_CEMETARY
	const ENGINE_FLYPOINT_UNIVERCITY
	const ENGINE_FLYPOINT_EEVEE_RANCH
	const ENGINE_FLYPOINT_JUNGLE
	const ENGINE_FLYPOINT_VOLCANO_EXTERIOR
	const ENGINE_FLYPOINT_MAYBE_VILLAGE
	const ENGINE_FLYPOINT_IVY_ROAD
	const ENGINE_FLYPOINT_THE_DARK_LAB
	const ENGINE_FLYPOINT_INDIGO
