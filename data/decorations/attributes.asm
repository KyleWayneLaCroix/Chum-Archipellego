...
; entries correspond to deco constants
	...
	decoration DECO_POSTER,  EMOLGA,         SET_UP_POSTER,     EVENT_DECO_POSTER_2,                $23
	decoration DECO_POSTER,  EMOLGA,        SET_UP_POSTER,     EVENT_DECO_POSTER_3,                $24
	decoration DECO_POSTER,  EMOLGA,      SET_UP_POSTER,     EVENT_DECO_POSTER_4,                $25
