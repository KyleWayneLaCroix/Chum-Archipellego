...
MapGroup_LinksAwakening:
	...
	map MisplacedCavern1F, TILESET_LINKS_AWAKENING_DUNGEON, DUNGEON, LANDMARK_MISPLACED_WOODS, MUSIC_DARK_CAVE, TRUE, PALETTE_AUTO, FISHGROUP_POND
	map MisplacedCavern2F, TILESET_LINKS_AWAKENING_DUNGEON, DUNGEON, LANDMARK_MISPLACED_WOODS, MUSIC_DARK_CAVE, TRUE, PALETTE_AUTO, FISHGROUP_POND
	map MisplacedCavernB1F, TILESET_LINKS_AWAKENING_DUNGEON, DUNGEON, LANDMARK_MISPLACED_WOODS, MUSIC_MOBILE_ADAPTER, TRUE, PALETTE_AUTO, FISHGROUP_POND
