...
MapGroup_NewBark:
	...
	map NewBarkTown, TILESET_CHUMELAGO, TOWN, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, TRUE, PALETTE_AUTO, FISHGROUP_OCEAN
	map PlayersHouse1F, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map PlayersHouse2F, TILESET_PLAYERS_ROOM, INDOOR, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_BrologueNorth:
	...
	map IceTown, TILESET_CHUMELAGO, TOWN, LANDMARK_ICE_TOWN, MUSIC_VIOLET_CITY, TRUE, PALETTE_AUTO, FISHGROUP_OCEAN
	map IceTownPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_ICE_TOWN, MUSIC_POKEMON_CENTER, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map IceTownMart, TILESET_MART, INDOOR, LANDMARK_ICE_TOWN, MUSIC_MOBILE_CENTER, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map IceTownTrainerClub, TILESET_GATE, INDOOR, LANDMARK_ICE_TOWN, MUSIC_GYM, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map IceTownHouse1, TILESET_HOUSE, INDOOR, LANDMARK_ICE_TOWN, MUSIC_VIOLET_CITY, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map IceTownHouse2, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_ICE_TOWN, MUSIC_VIOLET_CITY, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map SanhaHouse, TILESET_MANSION, INDOOR, LANDMARK_ICE_TOWN, MUSIC_VIOLET_CITY, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map SanhaHouse2F, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_ICE_TOWN, MUSIC_BUG_CATCHING_CONTEST_RANKING, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map SanhaHouseB1F, TILESET_CAVE, INDOOR, LANDMARK_ICE_TOWN, MUSIC_BUG_CATCHING_CONTEST_RANKING, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map SanhaACRoom, TILESET_ICE_PATH, INDOOR, LANDMARK_ICE_TOWN, MUSIC_BUG_CATCHING_CONTEST_RANKING, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Dungeons:
	...
	map FrozenCavern1F, TILESET_ICE_PATH, DUNGEON, LANDMARK_FROZEN_CAVERN, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map FrozenCavernB1F, TILESET_ICE_PATH, DUNGEON, LANDMARK_FROZEN_CAVERN, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map FrozenCavern2F, TILESET_ICE_PATH, DUNGEON, LANDMARK_FROZEN_CAVERN, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map FrozenCavern3F, TILESET_ICE_PATH, DUNGEON, LANDMARK_FROZEN_CAVERN, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map FrozenGrotto, TILESET_ICE_PATH, DUNGEON, LANDMARK_FROZEN_CAVERN, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	...
	map TheDarkLab, TILESET_LAB, DUNGEON, LANDMARK_AWAKENING_BEACH, MUSIC_ROCKET_HIDEOUT, TRUE, PALETTE_AUTO, FISHGROUP_LAKE
	map TheDarkLabBrianRoom, TILESET_LAB, DUNGEON, LANDMARK_AWAKENING_BEACH, MUSIC_ROCKET_HIDEOUT, TRUE, PALETTE_AUTO, FISHGROUP_LAKE
	map TheBetweensSafariZone, TILESET_JUNGLE, DUNGEON, LANDMARK_CYBERSPACE1, MUSIC_VICTORY_ROAD, TRUE, PALETTE_DAY, FISHGROUP_LAKE
	map TheBetweensMetroid, TILESET_METROID, DUNGEON, LANDMARK_CYBERSPACE1, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map TheBetweensPokecenter1F, TILESET_POKECENTER, DUNGEON, LANDMARK_CYBERSPACE1, MUSIC_VICTORY_ROAD, TRUE, PALETTE_AUTO, FISHGROUP_LAKE 
	map TheBetweensVictoryRoad, TILESET_CAVE, DUNGEON, LANDMARK_CYBERSPACE1, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map TheBetweensIcePath, TILESET_ICE_PATH, DUNGEON, LANDMARK_CYBERSPACE1, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map TheBetweensTown, TILESET_KANTO, DUNGEON, LANDMARK_CYBERSPACE1, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map TheBetweensMart, TILESET_MART, DUNGEON, LANDMARK_CYBERSPACE1, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map TheBetweensFacility, TILESET_FACILITY, DUNGEON, LANDMARK_CYBERSPACE1, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map TheBetweensEliteFourRoom, TILESET_ELITE_FOUR_ROOM, DUNGEON, LANDMARK_CYBERSPACE1, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map TheBetweensForest, TILESET_FOREST, DUNGEON, LANDMARK_CYBERSPACE1, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map TheBetweensTraditionalHouse, TILESET_TRADITIONAL_HOUSE, DUNGEON, LANDMARK_CYBERSPACE1, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map TheBetweensLinksAwakeningInterior, TILESET_LINKS_AWAKENING_INTERIOR, DUNGEON, LANDMARK_CYBERSPACE1, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map KylesDesktopRoom, TILESET_ICE_PATH, DUNGEON, LANDMARK_CYBERSPACE1, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_LAKE
