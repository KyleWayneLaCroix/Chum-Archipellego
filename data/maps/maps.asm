...
MapGroup_BattleTower:
	...
	map BattleTowerOutside, TILESET_BATTLE_TOWER_OUTSIDE, ROUTE, LANDMARK_BATTLE_TOWER, MUSIC_BATTLE_TOWER_THEME, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_LinksAwakening:
	...
	map AwakeningBeach2, TILESET_LINKS_AWAKENING, ROUTE, LANDMARK_CYBERSPACE1, MUSIC_GOLDENROD_CITY, TRUE, PALETTE_AUTO, FISHGROUP_OCEAN
	map MaybeVillage, TILESET_LINKS_AWAKENING, TOWN, LANDMARK_CYBERSPACE1, MUSIC_GOLDENROD_CITY, TRUE, PALETTE_AUTO, FISHGROUP_OCEAN
	map MisplacedWoods, TILESET_LINKS_AWAKENING, ROUTE, LANDMARK_CYBERSPACE1, MUSIC_GOLDENROD_CITY, TRUE, PALETTE_AUTO, FISHGROUP_OCEAN
	map BadEggExterior, TILESET_LINKS_AWAKENING, INDOOR, LANDMARK_CYBERSPACE1, MUSIC_GOLDENROD_CITY, TRUE, PALETTE_DAY, FISHGROUP_OCEAN
