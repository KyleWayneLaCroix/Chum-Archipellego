...
MapGroup_EeveeRanch:
	...
	map EeveeRanchInterior, TILESET_RADIO_TOWER, INDOOR, LANDMARK_EEVEE_RANCH, MUSIC_MOBILE_ADAPTER, TRUE, PALETTE_AUTO, FISHGROUP_POND
	map EeveeRanchGroomers, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_EEVEE_RANCH, MUSIC_MOBILE_ADAPTER, TRUE, PALETTE_AUTO, FISHGROUP_POND
