...
MapGroup_Brologue:
	...
	map RouteA, TILESET_CHUMELAGO, ROUTE, LANDMARK_ROUTE_A, MUSIC_ROUTE_26, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map RouteAPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_ROUTE_A, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GearCity, TILESET_CHUMELAGO, ROUTE, LANDMARK_GEAR_CITY, MUSIC_ROUTE_26, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
...
MapGroup_Dungeons:
	...
	map NorthernForest, TILESET_FOREST, CAVE, LANDMARK_NORTHERN_FOREST, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_POND
	map CityGearHQ, TILESET_MART, INDOOR, LANDMARK_GEAR_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
