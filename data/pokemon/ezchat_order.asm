...
.a:        db EKANS, ARBOK, SEAKING, ARIADOS, DOUBLADE, UNOWN, -1
...
.o:        db AEGISLASH, FURRET, OCTILLERY, PRIMEAPE, SENTRET, STANTLER, SPEAROW, FEAROW, OMASTAR, OMANYTE, -1
...
.ne:       db NATU, XATU, -1
.no:       db DUNSPARCE, -1
.ha_ba_pa: db SEEL, STEELIX, CHANDELURE, DRAGONAIR, BUTTERFREE, SCIZOR, HOPPIP, BLISSEY, PARAS, PARASECT, QWILFISH, MR__MIME, TYROGUE, CLOYSTER, TYRANITAR, -1
.hi_bi_pi: db CLEFFA, WEEDLE, PIKACHU, CLEFABLE, PIDGEOT, PIDGEOTTO, PICHU, CLEFAIRY, CHARMANDER, STARYU, LITWICK, SUNKERN, TEDDIURSA, VOLTORB, -1
...
.he_be_pe: db DOOMSTONE, GRIMER, MUK, HERACROSS, HOUNDOOM, PERSIAN, LICKITUNG, -1
.ho_bo_po: db HO_OH, HOOTHOOT, PIDGEY, PONYTA, SKIPLOOM, PORYGON, PORYGON2, -1
.ma:       db MAGCARGO, SLUGMA, LAMPENT, BELLSPROUT, WEEZING, MARILL, AZUMARILL, ELECTRODE, MANKEY, MANTINE, -1
.mi:       db DRATINI, MEW, MEWTWO, MILTANK, -1
.mu:       db MISDREAVUS, SMOOCHUM, -1
.me:       db CRYPTIID, DITTO, TENTACOOL, MAREEP, -1
...
.ro:       db VULPIX, -1
.wa:       db JUMPLUFF, HONEDGE, MACHOP ;, -1
.end:      db -1
