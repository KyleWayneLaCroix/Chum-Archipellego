 db GALLADE
	...
	; tm/hm learnset
	tmhm BODY_SLAM, CALM_MIND, CALM_MIND, CUT, EARTHQUAKE, ENERGY_BALL, FIRE_PUNCH, FLASH, GIGA_IMPACT, HIDDEN_POWER, HYPER_BEAM, HYPER_VOICE, ICE_PUNCH, NIGHT_SLASH, POISON_JAB, PSYBEAM, PSYCHIC_M, PSYCHIC_M, RAIN_DANCE, RETURN, ROCK_SLIDE, SHADOW_BALL, SHOCK_WAVE, SLEEP_TALK, STRENGTH, SUBMISSION, SUBSTITUTE, SUNNY_DAY, SWIFT, THUNDERBOLT, TOXIC, ZEN_HEADBUTT, ZEN_HEADBUTT
	; end
