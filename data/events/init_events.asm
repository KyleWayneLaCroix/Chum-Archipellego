InitialEvents:
	...
	dw EVENT_HAVE_NOT_STOLEN
	dw EVENT_BEAT_DETECTIVE_GUM
	dw EVENT_BEAT_DETECTIVE_JANE
	dw EVENT_SAW_KAEPORA_ON_BEACH
	dw EVENT_SAW_KAEPORA_IN_WOODS
	dw EVENT_CHAIR_BRIAN_2_DISAPPEARED
	dw EVENT_THE_BETWEENS_ICE_PATH_BOULDER_MISSING
	dw EVENT_BEAT_KYLE_2
	dw EVENT_BEAT_BIG_FURIOUS_B
...
InitialEngineFlags:
	...
	dw ENGINE_UNLOCKED_UNOWNS_A_TO_K
	dw ENGINE_UNLOCKED_UNOWNS_L_TO_R
	dw ENGINE_UNLOCKED_UNOWNS_S_TO_W
	dw ENGINE_UNLOCKED_UNOWNS_X_TO_Z
	dw -1 ; end
...
ENDM
	...
	initvarsprite SPRITE_OLIVINE_RIVAL, SPRITE_COOLTRAINER_M
	initvarsprite SPRITE_AZALEA_ROCKET, SPRITE_ROCKET
	initvarsprite SPRITE_FUCHSIA_GYM_1, SPRITE_ELM
	initvarsprite SPRITE_FUCHSIA_GYM_2, SPRITE_ELM
	initvarsprite SPRITE_FUCHSIA_GYM_3, SPRITE_ELM
	initvarsprite SPRITE_FUCHSIA_GYM_4, SPRITE_ELM
	initvarsprite SPRITE_COPYCAT, SPRITE_LASS
	initvarsprite SPRITE_VOLCANO_3F_LEVER, SPRITE_LEVER_LEFT
	initvarsprite SPRITE_VOLCANO_4F_LEVER, SPRITE_LEVER_LEFT
