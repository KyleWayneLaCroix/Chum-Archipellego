...
; entries correspond to NPCTRADE_* constants
	...
	npctrade TRADE_DIALOGSET_COLLECTOR, GASTLY,       HATENNA,     "HAZEL@@@@@@", $37, $66, TWISTEDSPOON, 42069, "TAYLOR@@@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_GIRL,      PURRLOIN,     MEOWTH,      "MEOWY@@@@@@", $96, $66, QUICK_CLAW,   44666, "KOBENI@@@@@", TRADE_GENDER_EITHER
