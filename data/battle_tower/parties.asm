...
; BattleTowerMons group 2
	...
	db BOUNSWEET
	db GOLD_BERRY
	db THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, HYPER_VOICE
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 3
	...
	db PURRLOIN
	db GOLD_BERRY
	db BLIZZARD, HYPNOSIS, DREAM_EATER, ATTRACT
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 4
	...
	db SPHEAL
	db FOCUS_BAND
	db EXPLOSION, EARTHQUAKE, HYPER_VOICE, ROCK_SLIDE
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db MAMOSWINE
	db BRIGHTPOWDER
	db STRENGTH, STOMP, PSYCH_UP, CONFUSION
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 7
	...
	db CRYPTIID
	db BRIGHTPOWDER
	db SUNNY_DAY, SOLARBEAM, RECOVER, HYPER_BEAM
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 8
	...
	db PURRLOIN
	db QUICK_CLAW
	db HYPNOSIS, BLIZZARD, DREAM_EATER, PSYCHIC_M
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 55000
