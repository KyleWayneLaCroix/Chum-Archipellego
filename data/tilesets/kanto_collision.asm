	...
	tilecoll WALL, HOP_DOWN_LEFT, WALL, WALL ; 89
	tilecoll WALL, HOP_LEFT, WALL, HOP_LEFT ; 8a
	tilecoll FLOOR, FLOOR, WALL, WALL ; 8b
	tilecoll FLOOR, FLOOR, FLOOR, FLOOR ; 8c
	tilecoll FLOOR, FLOOR, WARP_CARPET_DOWN, WARP_CARPET_DOWN ; 8d
	tilecoll WARP_CARPET_LEFT, FLOOR, WARP_CARPET_LEFT, FLOOR ; 8e
	tilecoll WARP_CARPET_LEFT, FLOOR, WARP_CARPET_LEFT, FLOOR ; 8f
	tilecoll WALL, WARP_CARPET_UP, WALL, FLOOR ; 90
	tilecoll WARP_CARPET_UP, WARP_CARPET_UP, FLOOR, WALL ; 91
