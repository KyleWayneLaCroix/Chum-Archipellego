...
; BERRY
	item_attribute 10, HELD_BERRY, 10, CANT_SELECT, BERRY, ITEMMENU_PARTY, ITEMMENU_PARTY
; GOLD_BERRY
	item_attribute 10, HELD_BERRY, 30, CANT_SELECT, BERRY, ITEMMENU_PARTY, ITEMMENU_PARTY
; MYSTERYBERRY
	item_attribute 10, HELD_RESTORE_PP, -1, CANT_SELECT, BERRY, ITEMMENU_PARTY, ITEMMENU_PARTY
; MIRACLEBERRY
	item_attribute 10, HELD_HEAL_STATUS, 0, CANT_SELECT, BERRY, ITEMMENU_PARTY, ITEMMENU_PARTY
; PSNCUREBERRY
	item_attribute 10, HELD_HEAL_POISON, 0, CANT_SELECT, BERRY, ITEMMENU_PARTY, ITEMMENU_PARTY
; PRZCUREBERRY
	item_attribute 10, HELD_HEAL_PARALYZE, 0, CANT_SELECT, BERRY, ITEMMENU_PARTY, ITEMMENU_PARTY
; BURNT_BERRY
	item_attribute 10, HELD_HEAL_FREEZE, 0, CANT_SELECT, BERRY, ITEMMENU_PARTY, ITEMMENU_PARTY
; ICE_BERRY
	item_attribute 10, HELD_HEAL_BURN, 0, CANT_SELECT, BERRY, ITEMMENU_PARTY, ITEMMENU_PARTY
; BITTER_BERRY
	item_attribute 10, HELD_HEAL_CONFUSION, 0, CANT_SELECT, BERRY, ITEMMENU_NOUSE, ITEMMENU_PARTY
; MINT_BERRY
	item_attribute 10, HELD_HEAL_SLEEP, 0, CANT_SELECT, BERRY, ITEMMENU_PARTY, ITEMMENU_PARTY
; RED_APRICORN
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, BERRY, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BLU_APRICORN
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, BERRY, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; YLW_APRICORN
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, BERRY, ITEMMENU_NOUSE, ITEMMENU_NOUSE
