...
JordanGroup:
	...
	; JORDAN (3)
	db "SMOOTI@", TRAINERTYPE_NICKNAME | TRAINERTYPE_DVS | TRAINERTYPE_MOVES
	db 42, FLAREON, "FLARIE@",	ATKDEFDV_SHINY, SPDSPCDV_SHINY,	BITE,			FIRE_LASH,		SLASH,			DOUBLE_KICK
	db 42, GLACEON,	"GLACIE@",	$99, $99, 						ICICLE_CRASH,	MIRROR_COAT,	HAIL,			PROTECT
	db 42, UMBREON, "UMBRIE@",	ATKDEFDV_SHINY, SPDSPCDV_SHINY, DARK_PULSE,		ZEN_HEADBUTT,	CONFUSE_RAY,	PURSUIT
	db 42, ESPEON,  "ESPIE@",	$99, $99, 						PSYCHIC_M,		SHADOW_BALL,	SWIFT,			FUTURE_SIGHT
	db 42, SYLVEON, "SYLVIE@",	$99, $99, 						DAZZLE_BEAM,	SWEET_KISS,		CHARM, 			RECOVER
	db 42, BUZZEON, "BEEIE@",	$99, $99, 						SIGNAL_BEAM, 	TWINEEDLE,		GIGA_DRAIN,		POISON_JAB
	db -1 ; end
...
CeoGroup:
	...
	db 45, BOLTUND, "DOGE@"
	db 43, SIRFETCHD, "M'LADY@"
	db 42, GARBODOR, "S.E.C.@"
	db -1 ; end
...
GrampsGroup:
	...
	db 53, ORANGURU, TWISTEDSPOON
	db 53, DRAMPA,   GOLD_BERRY
	db 53, URSALUNA, POLKADOT_BOW
	db -1 ; end
...
GrannyGroup:
	...
	db 48, HATTERENE, TWISTEDSPOON
	db 48, MISMAGIUS, SPELL_TAG
	db 48, LIEPARD, BLACKGLASSES
	db -1 ; end
...
RedGroup:
	...
	db 57, EMOLGA,		"PIKACHU@",		CHARM,			QUICK_ATTACK,	THUNDERBOLT,	THUNDER
	db 54, ESPEON,		"ESPEON@",		MUD_SLAP,		REFLECT, 		SWIFT, 			PSYCHIC_M
	db 53, SNORLAX,		"SNORLAX@",		AMNESIA,		SNORE, 			REST, 			BODY_SLAM
	db 55, TSAREENA,	"VENOSAUR@",	SUNNY_DAY,		GIGA_DRAIN,		RECOVER,		SOLARBEAM
	db 53, CHANDELURE,  "CHARIZARD@",	FLAMETHROWER,	WING_ATTACK,	SLASH,			FIRE_SPIN
	db 56, SEISMITOAD,	"BLASTOISE@",	RAIN_DANCE,		SURF,			BLIZZARD,		WHIRLPOOL
	db -1 ; end
...
SageGroup:
	...
	db 45, GENGAR,		SPORE, DREAM_EATER, SHADOW_BALL, CONFUSE_RAY
	db 45, MISMAGIUS,	SPORE, DREAM_EATER, PERISH_SONG, HYPER_VOICE
	db 45, CRYPTIID,	SPORE, DREAM_EATER, GRAVE_SMASH, SHADOW_CLAW
	db 45, CHANDELURE,	SPORE, DREAM_EATER, FLAMETHROWER, SIGNAL_BEAM
	db -1 ; end
...
TheEmptyGroup:
	...
	db 50, PORYGON_Z,	GIGA_IMPACT, SWORDS_DANCE, DOUBLE_TEAM, RECOVER
	db 50, PORYGON_Z,	HYPER_BEAM, CALM_MIND, PSYCHIC_M, MOONBLAST
	db 50, PORYGON_Z,	SIGNAL_BEAM, FLAMETHROWER, PSYBEAM, THUNDERBOLT
	db -1 ; end
