...
WillGroup:
	; WILL (1)
	db "WILL@", TRAINERTYPE_DVS | TRAINERTYPE_MOVES
	...
	db 33, MAMOSWINE,		ATKDEFDV_SHINY, SPDSPCDV_SHINY,	ANCIENTPOWER, 
	db 25, AMAURA,			ATKDEFDV_SHINY, SPDSPCDV_SHINY,	ANCIENTPOWER, 
	db 25, MINIOR_METEOR,	ATKDEFDV_SHINY, SPDSPCDV_SHINY,	ANCIENTPOWER, 
	db 200, DUOSION,			ATKDEFDV_SHINY, SPDSPCDV_SHINY,	ANCIENTPOWER, 
	db -1 ; end
