...
.JohtoStarters: db BUENA_MON,    10, SPIRRIP, LITWICK, HONEDGE
...
.Pokemon1:      db BUENA_MON,    10, RALTS, JUMPLUFF, SCYTHER
.Pokemon2:      db BUENA_MON,    10, HERDIER, TIRTOUGA, DRAGAPULT
